...
<body>
    ...
    <div class="grid-container">
        <div class="grid-item">
            <p> Natural disasters happen when the weather gets crazy! There are
                a bunch of different disasters that can happen. Some disasters 
                happen more often in different places. Some natural disasters are:
                tornadoes, hurricanes, floods, volcano eruptions, and more!
            </p>
        </div>
        <div class="grid-item">
            <iframe width="560" height="315" src="https://www.youtube.com/embed/QVZExLO0MWA" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
    </div>
</body>
</html>
